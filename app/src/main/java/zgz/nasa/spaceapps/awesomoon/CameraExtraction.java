...
/**
 * Created by Jimmy on 23/04/2016.
 */
public class CameraExtraction extends ViewGroup implements SurfaceHolder.Callback {
    ...
    int cameraId;
    Rect desiredSize;
    CameraFindExtractionFragment.CameraViewMode cameraViewMode;
    ...
    public CameraExtraction(Context context, int rotation) {
        ...
        cameraViewMode = CameraFindExtractionFragment.CameraViewMode.Inner;
    }
